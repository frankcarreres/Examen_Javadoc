...
/**
 * - Esta clase reprsenta a la pieza de la Reina.
 * @author Frank
 * @version 05/05/2023
 */
public class Queen extends Piece{
	...
	/**
         * Determina los posibles movimientos de la Reina dado el estado del 
         * tablero y su posición actual
         * @param state
         * @param x --> La coordenada x de la posicion de la Reina.
         * @param y --> La coordenada y de la posicion de la Reina.
         * @return Una Arraylist con los posibles moviemientos de la Reina.
         */
