...
/**
 * - Esta clase representa a la pieza del Rey.
 * 
 * @author Frank 
 * @version 05/05/2023
 */
...
public class King extends Piece{
	...
	private int x,y; //Extra variables for King class to keep a track of king's position
        ...
        /**
         * 
         * @param i --> Representa el ID del Rey.
         * @param p --> Representa la Representa la ruta del archivo donde esta la pieza de la imagen.
         * @param c --> Representa el color del Rey (0 Blanco, 1 Negro)
         * @param x --> La coordenada x de la posicion del Rey.
         * @param y --> La coordenada y de la posicion del Rey.
         */
	...
	public int gety()
	{
        ...
        /**
         * Determina los posibles movimientos del Rey dado el estado del 
         * tablero y su posición actual.
         * @param state
         * @param x
         * @param y
         * @return Una ArrayList de las posibles coordenadas del Rey. 
         */
