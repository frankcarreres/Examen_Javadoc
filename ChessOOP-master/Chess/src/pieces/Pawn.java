...
/**
 * - Representa a la pieza del Peon
 * @author Frank
 * @version 05/05/2023
 */
public class Pawn extends Piece{
	...
	/**
         * Determina los posibles movimientos del Peón dado el estado del 
         * tablero y su posición actual
         * @param state
         * @param x --> La coordenada x de la posicion del Peón.
         * @param y --> La coordenada y de la posicion del Peón.
         * @return Una Arraylist con los posiblrs moviemientos del Peón.
         */
